...
import arrowslogo from '../../images/arrows.svg';

function Switcher() {
  return (
    <div className="switcher">

      <div className="switcher__cont switcher__cont_active">
        ...
        <p className="switcher__title">Runtime</p>
      </div>

      <div className="switcher__cont">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="switcher__title">Constructor</p>
      </div>
